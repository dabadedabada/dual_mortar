...
n0 = get_n0(cont_face, averaged_normals);
[t1,t2] = get_tangents(cont_face, averaged_normals);

% Centroids also calculated by mapping the center of reference element
centroids = get_centroids(cont_face);
...
normals_storage.n0 = n0;
normals_storage.x0 = centroids;
